...
Project Assignment 1 : [Containerized Web Application Report](./Project-Assignment-1/report.md)
...
![Terminal showing docker run execution and docker ps](./assets/exp_6_1.png)

![Browser showing http://localhost:8081 output](./assets/exp_6_2.png)
